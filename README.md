...
| `frieren` | 葬送的芙莉莲 | 深色 | 青灰墨 + 翡翠绿 + 晨金 |
| `chainsaw-man` | 电锯人 | 深色 | 暗夜红黑 + 链锯橙红 |
| `jujutsu-kaisen` | 咒术回战 | 深色 | 夜蓝墨 + 五条苍蓝 |
| `honkai-star-rail` | 崩坏·星穹铁道 | 深色 | 星夜蓝紫 + 星穹蓝紫金 |
| `wuthering-waves` | 鸣潮 | 深色 | 声骸墨青 + 共鸣青绿 |
| `one-piece` | 海贼王 | 深色 | 航路棕金 + 草帽金橙 |
| `naruto` | 火影忍者 | 深色 | 木叶墨棕 + 忍道橙火 |
| `bocchi-the-rock` | 孤独摇滚 | 深色 | 深夜紫黑 + 波奇粉 |
